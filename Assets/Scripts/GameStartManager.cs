...
public class GameStartManager : MonoBehaviour
{
    ...
    public float darknessDelay = 1f; // Time the player stays in darkness before the transition happens
    ...
    public void StartGame()
    {
        ...
        cameraMover.MoveCameraToTarget();
    ...
    private IEnumerator GameStartSequence()
    {
        ...
        // This disables the virtual camera
